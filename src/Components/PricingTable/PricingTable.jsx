  ...
  <section className="bg-[#f4ece4] py-16">
    ...
    <div className="container mx-auto px-6">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        <div className="w-full sm:w-1/3 bg-[#3e2723] p-6 rounded-lg shadow-lg" data-aos='fade-right'>
        ...
        <div className="w-full sm:w-1/3 bg-[#3e2723] p-6 rounded-lg shadow-lg" data-aos='fade-left'>
